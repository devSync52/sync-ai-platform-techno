      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-2 ">
        {navItems.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-white text-sm font-medium transition-all
                ${isActive
        ...
        <div>
          <button
            ...
            className="w-full flex items-center justify-between gap-2 px-3 py-2 text-sm tracking-wider hover:bg-[#352682] transition"
          >
