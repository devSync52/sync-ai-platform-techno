export async function POST(req: Request) {
  ...
  const syncUrls: Record<'sellercloud' | 'extensiv' | 'magaya', string> = {
    ...
    magaya: 'https://euzjrgnyzfgldubqglba.supabase.co/functions/v1/get_magaya_orders',
  }
  ...
  const response = await fetch(syncUrls[source as 'sellercloud' | 'extensiv' | 'magaya'], {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
