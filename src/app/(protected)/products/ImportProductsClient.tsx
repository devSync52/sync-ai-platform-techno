      ...
      ? Object.values(
          products.reduce(
            (acc, product) => {
              ...
              if (
                !acc[key] ||
                new Date(product.updated_at ?? 0) >
                  new Date(acc[key].updated_at ?? 0)
              ) {
                acc[key] = product;
              }
              return acc;
  ...
  const sourceOptions = [
    ...
    ...Array.from(
      new Set(
        (sources.length
          ? sources
          : products.map((p) => p.product_source)
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-0 sm:p-0 space-y-5">
      ...
      <div className="flex items-center justify-end gap-4 mb-0 text-sm">
        ...
        <Button onClick={() => exportToCSV(filtered)} className="text-sm">
          Export CSV
        </Button>
      </div>
            ...
            {paginatedProducts.map((product) => (
              ...
              >
                ...
                <td className="py-3 px-4 text-gray-600">
                  ...
                  product.pkg_width_in &&
                  product.pkg_height_in
